...
<?php else: ?>
    ...
    <div class="empty-mailbox">
        <p><?php echo __('Want to communicate on a more personal level with your friends? Send a message now!', GEODIRECTORY_FRAMEWORK) ?></p>
        <?php $comp_link = bp_loggedin_user_domain() . bp_get_messages_slug() . '/compose/'; ?>
        <a href="<?php echo $comp_link ?>" class="whoop-btn whoop-btn-primary whoop-compose-message"><?php echo __('Compose', GEODIRECTORY_FRAMEWORK) ?></a>
    </div>
