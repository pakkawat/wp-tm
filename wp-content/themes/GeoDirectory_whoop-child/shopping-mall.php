<?php /* Template Name: All shopping mall */ ?>
<?php get_header(); ?>
      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
        ...
        <section class="entry-content cf" itemprop="articleBody">
          <ul class="locations_list">
            <li class="region">
              <a href="<?php echo home_url('/places/').'/';?>">เซ็นทรัล</a>
            </li>
            <li class="region">
              <a href="<?php echo home_url('/places/').'/';?>">เดอะมอลล์</a>
            </li>
            <li class="region">
              <a href="<?php echo home_url('/places/').'/';?>">โรบินสัน</a>
            </li>
          </ul>
        </section>
