...
(function (b) {
    ...
    r = p && /msie 7.0/.test(k);
    b.gdmodal = function (a, h) {
        return b.gdmodal.impl.init(a, h)
    };
    b.gdmodal.close = function () {
        b.gdmodal.impl.close()
    };
    b.gdmodal.focus = function (a) {
        b.gdmodal.impl.focus(a)
    };
    b.gdmodal.setContainerDimensions =
        function () {
            b.gdmodal.impl.setContainerDimensions()
        };
    b.gdmodal.setPosition = function () {
        b.gdmodal.impl.setPosition()
    };
    b.gdmodal.update = function (a, h) {
        b.gdmodal.impl.update(a, h)
    };
    b.fn.gdmodal = function (a) {
        return b.gdmodal.impl.init(this, a)
    };
    b.gdmodal.defaults = {
        appendTo: "body",
        focus: !0,
    ...
    b.gdmodal.impl = {
        d: {}, init: function (a, h) {
            ...
            o = p && (document.compatMode === "BackCompat");
            this.o = b.extend({}, b.gdmodal.defaults, h);
            ...
            this.getDimensions();
            if (this.o.gdmodal && m)this.d.iframe = b('<iframe src="javascript:false;"></iframe>').css(b.extend(this.o.iframeCss,
                {
                    display: "none",
                    opacity: 0,
                    position: "fixed",
            ...
            this.d.overlay = b("<div></div>").attr("id", this.o.overlayId).addClass("simplemodal-overlay").css(b.extend(this.o.overlayCss, {
                ...
                height: this.o.gdmodal ? j[0] : 0,
                width: this.o.gdmodal ? j[1] : 0,
                position: "fixed",
                left: 0,
                top: 0,
            ...
            a.o.gdmodal && a.o.close && a.o.overlayClose && a.d.overlay.bind("click.simplemodal", function (b) {
                b.preventDefault();
                a.close()
            });
            n.bind("keydown.simplemodal", function (b) {
                a.o.gdmodal && 9 === b.keyCode ? a.watchTab(b) : a.o.close && a.o.escClose && 27 === b.keyCode && (b.preventDefault(), a.close())
            });
            l.bind("resize.simplemodal orientationchange.simplemodal",
                function () {
                    a.getDimensions();
                    a.o.autoResize ? a.setContainerDimensions() : a.o.autoPosition && a.setPosition();
                    m || o ? a.fixIE() : a.o.gdmodal && (a.d.iframe && a.d.iframe.css({
                        height: g[0],
                        width: g[1]
            ...
            b.each([this.d.iframe || null, !this.o.gdmodal ? null : this.d.overlay,
