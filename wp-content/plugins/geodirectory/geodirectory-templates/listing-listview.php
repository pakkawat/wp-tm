...
?>
    ...
    <ul class="geodir_category_list_view clearfix <?php echo apply_filters('geodir_listing_listview_ul_extra_class', '', 'listing'); ?>">
        ...
        <!-- 20171109 Bank Add Order Now Below Pinpoint -->
        ...
        echo "<span class='glf-button' data-glf-cuid=",$post->geodir_CUID," data-glf-ruid=",$post->geodir_RUID," data-glf-auto-open='false'>ORDER NOW</span><script 
