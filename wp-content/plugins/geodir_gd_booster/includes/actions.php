...
namespace geodir_gd_booster // Root namespace.
{
	...
	class actions // Action handlers.
	{
		...
		public function restore_default_options($args)
		{
			...
			delete_option(__NAMESPACE__.'_notices'); // Blog-specific.
			if(is_multisite()) delete_site_option(__NAMESPACE__.'_notices');
			
			delete_option(__NAMESPACE__.'_errors'); // Blog-specific.
			if(is_multisite()) delete_site_option(__NAMESPACE__.'_errors');
